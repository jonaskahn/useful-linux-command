...
sudo mkdir -p /opt/overview
sudo mv -f overviews.png /opt/overview
sudo touch -f /usr/bin/overview
sudo chmod -f a+x /usr/bin/overview
sudo touch -f /usr/share/applications/overviews.desktop
